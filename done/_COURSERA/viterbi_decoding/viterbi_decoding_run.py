...
import bio_6.viterbi_decoding as core
...
result = core.viterbi_decoding(state_table, x_table, x, states)
print result
readFile.lineToOutput(result)
#
# expectedResult = "BADBACBADDDBADBDBACBDDBACADDDBACBACBBADBACADBDBADDBCBCBDBACCCBADDBADDBADDBADDBCBACADBADDBADBACBACADD"
# for i in xrange(0, len(result)):
#     if result[i] != expectedResult[i]:
#         print "wrong", i, ": ", expectedResult[i], " not ", result[i]
